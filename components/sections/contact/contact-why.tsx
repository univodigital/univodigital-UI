...
import { CONTACT_WHY_FEATURES } from "@/data/contact";
...
export function ContactWhy({ className }: ContactWhyProps) {
    ...
    >
      ...
      <Container size="max">
        ...
        <StaggerContainer
          ...
          once
        >
          {CONTACT_WHY_FEATURES.map((feature) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className={cn(cardIconWrapClassName, "size-11")}>
